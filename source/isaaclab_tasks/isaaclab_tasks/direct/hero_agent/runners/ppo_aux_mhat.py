...
Note:
    ...
    diff the parent update() method for changes.
"""
...
class PPOWithMHatAuxLoss(PPO):
    ...
    def update(self) -> dict[str, float]:
        ...
        for (
            ...
            # Forward pass: act() and evaluate() both call _get_combined_obs()
            # which runs adapt_tconv -> z_hat. _last_z is set after evaluate().
            ...
            mean_aux_mhat_loss += aux_mhat_loss.item()
        ...
        mean_aux_mhat_loss /= num_updates
        if mean_rnd_loss is not None:
