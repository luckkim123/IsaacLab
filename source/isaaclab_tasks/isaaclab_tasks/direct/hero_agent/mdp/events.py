...
def randomize_joint_positions(
    ...
    This function sets random initial positions for the 2 ALBC joints
    (joint1 and joint2) that control the buoyancy element.
    ...
    default_joint_vel = env._robot.data.default_joint_vel[env_ids].clone()

    # Randomize ALBC joint positions
    if hasattr(env, "_albc_joint_ids"):
        random_pos = (
