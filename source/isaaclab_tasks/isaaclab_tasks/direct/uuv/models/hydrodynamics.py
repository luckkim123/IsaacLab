...
class HydrodynamicsModel:
    ...
    def compute_forces(
        ...
        # Apply Fossen coordinate sign convention
    ...
    def _compute_damping(self, body_vel: torch.Tensor) -> torch.Tensor:
        ...
        maintained_body_vels[:, 1, 5] = body_vel[:, 5]
        maintained_body_vels[:, 2, 4] = body_vel[:, 4]
        maintained_body_vels[:, 4, 2] = body_vel[:, 2]
        maintained_body_vels[:, 5, 1] = body_vel[:, 1]
