...
"""Event functions for UUV domain randomization.

These functions follow Isaac Lab's EventTerm pattern and can be used with
EventCfg for configuring domain randomization in UUV environments.

The functions are designed to work with the UUV environment's hydrodynamics
...
def randomize_hydrodynamics(
    ...
    Args:
        env: The UUV environment instance.
