...
"""BlueROV2 hover environment configurations.

This module provides environment configurations for BlueROV2 hover tasks
...
@configclass
class BlueROVHoverEnvCfg(UUVEnvCfg):
    """BlueROV2 hover environment configuration.
...
class BlueROVHoverTrainEnvCfg(BlueROVHoverEnvCfg):
    """BlueROV2 hover training environment with domain randomization.
...
class BlueROVHoverEvalEnvCfg(BlueROVHoverEnvCfg):
    """BlueROV2 hover evaluation environment with aggressive randomization.
