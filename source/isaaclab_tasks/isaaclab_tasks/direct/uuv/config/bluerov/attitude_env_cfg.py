...
"""BlueROV2 attitude-only environment configurations.

This module provides environment configurations for BlueROV2 attitude control tasks
...
@configclass
class BlueROVAttitudeEnvCfg(UUVEnvCfg):
    """BlueROV2 attitude control environment configuration.
...
class BlueROVAttitudeTrainEnvCfg(BlueROVAttitudeEnvCfg):
    """BlueROV2 attitude training environment with domain randomization.
