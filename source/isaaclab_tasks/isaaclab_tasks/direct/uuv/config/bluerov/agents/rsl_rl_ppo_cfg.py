...
"""RSL-RL PPO agent configurations for BlueROV2 environments.
...
class BlueROVHoverPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    """RSL-RL PPO configuration for BlueROV2 hover task.
...
class BlueROVHoverTrainPPORunnerCfg(BlueROVHoverPPORunnerCfg):
    """PPO configuration for BlueROV2 hover training with domain randomization."""
...
class BlueROVHoverEvalPPORunnerCfg(BlueROVHoverPPORunnerCfg):
    """PPO configuration for BlueROV2 hover evaluation with aggressive randomization."""
...
class BlueROVAttitudePPORunnerCfg(RslRlOnPolicyRunnerCfg):
    """RSL-RL PPO configuration for BlueROV2 attitude-only task.
...
class BlueROVAttitudeTrainPPORunnerCfg(BlueROVAttitudePPORunnerCfg):
    """PPO configuration for BlueROV2 attitude training with domain randomization."""
