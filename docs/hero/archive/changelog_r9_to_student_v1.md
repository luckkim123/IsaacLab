# Changelog Archive: R9 → Student v1 (2026-04-18 ~ 2026-04-22)

> Archived session log. Covers Teacher ablation rounds R9–R14 and Student policy
> distillation v1 (TCN / GRU BC from r13_A teacher). Snapshot taken 2026-04-22.

## Covered Sessions (newest → oldest)
