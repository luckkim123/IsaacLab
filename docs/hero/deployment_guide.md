...
- `docs/hero/architecture/training_pipeline.md` — 훈련 파이프라인 개요
- `docs/hero/architecture/system_overview.md` — 시스템 전반 구성
- `docs/hero/architecture/reward_functions.md` — reward 구조
- `.claude/rules/03-analysis-quality.md` — 분석·검증 기준
- `docs/hero/experiments/` — 관련 실험 기록
